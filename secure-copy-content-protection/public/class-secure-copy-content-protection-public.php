...
class Secure_Copy_Content_Protection_Public {
	...
	public function sccp_blockcont_generate_shortcode( $atts, $content ) {
		...
		// Block content box Enable Container border width Mobile
        $block_content_settings['enable_bc_cont_border_width_mobile'] = ( isset( $block_content_settings['enable_bc_cont_border_width_mobile'] ) && $block_content_settings['enable_bc_cont_border_width_mobile'] == 'off') ? false : true;
        
        // Block content box Container border width Mobile
        if ( $block_content_settings['enable_bc_cont_border_width_mobile'] ) {
            $bc_cont_border_width_mobile = ( isset( $block_content_settings['bc_cont_border_width_mobile'] ) && $block_content_settings['bc_cont_border_width_mobile'] != '' ) ?  $block_content_settings['bc_cont_border_width_mobile'] : $bc_cont_border_width;
        } else {
            $bc_cont_border_width_mobile = $bc_cont_border_width;
        }
		...
		// Block content box button text color Mobile
		...
		// Enable Block content box button text color Mobile
        $block_content_settings['enable_bc_btn_text_color_mobile'] = ( isset( $block_content_settings['enable_bc_btn_text_color_mobile'] ) && $block_content_settings['enable_bc_btn_text_color_mobile'] == 'off') ? false : true;
        
        // Block content box button text color Mobile
        if ( $block_content_settings['enable_bc_btn_text_color_mobile'] ) {
            $ays_sccp_bc_btn_text_color_mobile = ( isset( $block_content_settings['bc_btn_text_color_mobile'] ) && $block_content_settings['bc_btn_text_color_mobile'] != '' ) ?  stripslashes( esc_attr( $block_content_settings['bc_btn_text_color_mobile'] ) ) : $ays_sccp_bc_btn_text_color;
        } else {
            $ays_sccp_bc_btn_text_color_mobile = $ays_sccp_bc_btn_text_color;
        }
		...
		$sccp_bc_btn_text_color_mobile = $ays_sccp_enable_bc_btn_style ? 'color:'.$ays_sccp_bc_btn_text_color_mobile.' !important;' : '';
        ...
        $block_content_settings['enable_bc_btn_radius_mobile'] = ( isset( $block_content_settings['enable_bc_btn_radius_mobile'] ) && $block_content_settings['enable_bc_btn_radius_mobile'] == 'off') ? false : true;
        
        // Block content box button border radius Mobile
        if ( $block_content_settings['enable_bc_btn_radius_mobile'] ) {
            $ays_sccp_bc_btn_radius_mobile = ( isset( $block_content_settings['bc_btn_radius_mobile'] ) && $block_content_settings['bc_btn_radius_mobile'] != '' ) ? sanitize_text_field( $block_content_settings['bc_btn_radius_mobile'] ) : $ays_sccp_bc_btn_radius;
        } else {
            $ays_sccp_bc_btn_radius_mobile = $ays_sccp_bc_btn_radius;
        }
		...
		// Block content box Buttons border style
        ...
        $block_content_settings['enable_bc_btn_border_style_mobile'] = ( isset( $block_content_settings['enable_bc_btn_border_style_mobile'] ) && $block_content_settings['enable_bc_btn_border_style_mobile'] == 'off') ? false : true;
        
        // Block content Buttons border style Mobile
        if ( $block_content_settings['enable_bc_btn_border_style_mobile'] ) {
            $ays_sccp_bc_btn_border_style_mobile = ( isset( $block_content_settings['bc_btn_border_style_mobile'] ) && $block_content_settings['bc_btn_border_style_mobile'] != '' ) ?  $block_content_settings['bc_btn_border_style_mobile'] : $ays_sccp_bc_btn_border_style;
        } else {
            $ays_sccp_bc_btn_border_style_mobile = $ays_sccp_bc_btn_border_style;
        }

		$sccp_bc_btn_border_style = $ays_sccp_enable_bc_btn_style ? 'border-style:'.$ays_sccp_bc_btn_border_style.';' : '';
		$sccp_bc_btn_border_style_mobile = $ays_sccp_enable_bc_btn_style ? 'border-style:'. $ays_sccp_bc_btn_border_style_mobile .' !important;' : '';
		...
		// Block content box Enable Buttons border color Mobile
        $block_content_settings['enable_bc_btn_border_color_mobile'] = ( isset( $block_content_settings['enable_bc_btn_border_color_mobile'] ) && $block_content_settings['enable_bc_btn_border_color_mobile'] == 'off') ? false : true;
        
        // Block content box Buttons border color Mobile
        if ( $block_content_settings['enable_bc_btn_border_color_mobile'] ) {
            $ays_sccp_bc_btn_border_color_mobile = ( isset( $block_content_settings['bc_btn_border_color_mobile'] ) && $block_content_settings['bc_btn_border_color_mobile'] != '' ) ?  stripslashes( esc_attr( $block_content_settings['bc_btn_border_color_mobile'] ) ) : $ays_sccp_bc_btn_border_color;
        } else {
            $ays_sccp_bc_btn_border_color_mobile = $ays_sccp_bc_btn_border_color;
        }

		$sccp_bc_btn_border_color = $ays_sccp_enable_bc_btn_style ? 'border-color:'.$ays_sccp_bc_btn_border_color.';' : '';
		$sccp_bc_btn_border_color_mobile = $ays_sccp_enable_bc_btn_style ? 'border-color:'.$ays_sccp_bc_btn_border_color_mobile.' !important;' : '';
