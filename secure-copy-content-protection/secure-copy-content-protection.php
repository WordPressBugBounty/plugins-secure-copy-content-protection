 ...
 */
define('SCCP_NAME_VERSION', '4.8.1');
            ...
            <div class="navigation-bar">
                <div id="navigation-container">                   
                    ...
                    <ul id="menu">
                        ...
                        <li class="modile-ddmenu-lg ays_sccp_take_gift modile-ddmenu-lg-custom"><a class="ays-btn" href="https://ays-demo.com/sccp-coupon-code-as-a-gift/" target="_blank"><?php echo esc_html__( "Grab your GIFT", 'secure-copy-content-protection' ); ?></a></li>
                        ...
                        <li class="modile-ddmenu-md">
                            ...
                            <ul class="ddmenu" data-expanded="false">
                                ...
                                <li class="ays_sccp_take_gift"><a class="ays-btn" href="https://ays-demo.com/sccp-coupon-code-as-a-gift/" target="_blank"><?php echo esc_html__( "Grab your GIFT", 'secure-copy-content-protection' ); ?></a></li>
