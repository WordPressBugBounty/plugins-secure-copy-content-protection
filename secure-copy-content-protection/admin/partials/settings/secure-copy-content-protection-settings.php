...
// Block box width mobile
$ays_sccp_bc_width_mobile = (isset($block_content['sccp_bc_width_mobile']) && $block_content['sccp_bc_width_mobile'] != '' && $block_content['sccp_bc_width_mobile'] != 0) ? absint( sanitize_text_field($block_content['sccp_bc_width_mobile']) ) : '' ;

// Block box width mobile by percentage or pixels
$sccp_bc_width_mobile_by_percentage_px = (isset($block_content['sccp_bc_width_mobile_by_percentage_px']) && $block_content['sccp_bc_width_mobile_by_percentage_px'] != '') ? $block_content['sccp_bc_width_mobile_by_percentage_px'] : 'pixels';
...
$block_content['enable_sccp_bc_bg_color_mobile'] = isset( $block_content['enable_sccp_bc_bg_color_mobile'] ) && $block_content['enable_sccp_bc_bg_color_mobile'] == 'off' ? 'off' : 'on';
$enable_ays_sccp_bc_bg_color_mobile = $block_content['enable_sccp_bc_bg_color_mobile'] == 'on' ?  true : false;

// Block content box Background Color Mobile
$ays_sccp_bc_bg_color_mobile = isset( $block_content['sccp_bc_bg_color_mobile'] ) && $block_content['sccp_bc_bg_color_mobile'] != '' ? esc_attr( $block_content['sccp_bc_bg_color_mobile'] ) : $ays_sccp_bc_bg_color;
...
$block_content['enable_bc_bg_image_position_mobile'] = isset( $block_content['enable_bc_bg_image_position_mobile'] ) && $block_content['enable_bc_bg_image_position_mobile'] == 'off' ? 'off' : 'on';
$enable_sccp_bc_bg_image_position_mobile = $block_content['enable_bc_bg_image_position_mobile'] == 'on' ?  true : false;

// Block content Bg image positioning Mobile
$sccp_bc_bg_image_position_mobile = isset( $block_content['bc_bg_image_position_mobile'] ) && $block_content['bc_bg_image_position_mobile'] != '' ? stripslashes ( esc_attr( $block_content['bc_bg_image_position_mobile'] ) ) : $sccp_bc_bg_image_position;
...
$block_content['enable_sccp_bc_button_text_mobile'] = isset( $block_content['enable_sccp_bc_button_text_mobile'] ) && $block_content['enable_sccp_bc_button_text_mobile'] == 'off' ? 'off' : 'on';
$enable_ays_sccp_bc_button_text_mobile = $block_content['enable_sccp_bc_button_text_mobile'] == 'on' ?  true : false;

// Block content box button text Mobile
$ays_sccp_bc_button_text_mobile = isset( $block_content['sccp_bc_button_text_mobile'] ) && $block_content['sccp_bc_button_text_mobile'] != '' ? stripslashes( esc_attr( $block_content['sccp_bc_button_text_mobile'] ) ) : $ays_sccp_bc_button_text;
...
// Enable Block content Container border style Mobile
$block_content['enable_bc_cont_border_style_mobile'] = isset( $block_content['enable_bc_cont_border_style_mobile'] ) && $block_content['enable_bc_cont_border_style_mobile'] == 'off' ? 'off' : 'on';
$enable_ays_sccp_bc_cont_border_style_mobile = $block_content['enable_bc_cont_border_style_mobile'] == 'on' ?  true : false;

// Block content Container border style Mobile
$ays_sccp_bc_cont_border_style_mobile = isset( $block_content['bc_cont_border_style_mobile'] ) && $block_content['bc_cont_border_style_mobile'] != '' ? esc_attr( $block_content['bc_cont_border_style_mobile'] ) : $ays_sccp_bc_cont_border_style;
...
$block_content['enable_bc_cont_border_color_mobile'] = isset( $block_content['enable_bc_cont_border_color_mobile'] ) && $block_content['enable_bc_cont_border_color_mobile'] == 'off' ? 'off' : 'on';
$enable_ays_sccp_bc_cont_border_color_mobile = $block_content['enable_bc_cont_border_color_mobile'] == 'on' ?  true : false;

// Block content Container border color Mobile
$ays_sccp_bc_cont_border_color_mobile = isset( $block_content['bc_cont_border_color_mobile'] ) && $block_content['bc_cont_border_color_mobile'] != '' ? esc_attr( $block_content['bc_cont_border_color_mobile'] ) : $ays_sccp_bc_cont_border_color;
...
$block_content['enable_bc_cont_border_width_mobile'] = isset( $block_content['enable_bc_cont_border_width_mobile'] ) && $block_content['enable_bc_cont_border_width_mobile'] == 'off' ? 'off' : 'on';
$enable_ays_sccp_bc_cont_border_width_mobile = $block_content['enable_bc_cont_border_width_mobile'] == 'on' ?  true : false;

// Block content box Container border width Mobile
$ays_sccp_bc_cont_border_width_mobile = isset( $block_content['bc_cont_border_width_mobile'] ) && $block_content['bc_cont_border_width_mobile'] != '' ? esc_attr( $block_content['bc_cont_border_width_mobile'] ) : $ays_sccp_bc_cont_border_width;
...
$block_content['enable_bc_text_alignment_mobile'] = isset( $block_content['enable_bc_text_alignment_mobile'] ) && $block_content['enable_bc_text_alignment_mobile'] == 'off' ? 'off' : 'on';
$enable_ays_sccp_bc_text_alignment_mobile = $block_content['enable_bc_text_alignment_mobile'] == 'on' ?  true : false;

// Block content text alignment Mobile
$ays_sccp_bc_text_alignment_mobile = isset( $block_content['bc_text_alignment_mobile'] ) && $block_content['bc_text_alignment_mobile'] != '' ? esc_attr( $block_content['bc_text_alignment_mobile'] ) : $ays_sccp_bc_text_alignment;
...
$block_content['enable_bc_btn_text_color_mobile'] = isset( $block_content['enable_bc_btn_text_color_mobile'] ) && $block_content['enable_bc_btn_text_color_mobile'] == 'off' ? 'off' : 'on';
$enable_ays_sccp_bc_btn_text_color_mobile = $block_content['enable_bc_btn_text_color_mobile'] == 'on' ?  true : false;

// Block content Button text color Mobile
$ays_sccp_bc_btn_text_color_mobile = isset( $block_content['bc_btn_text_color_mobile'] ) && $block_content['bc_btn_text_color_mobile'] != '' ? esc_attr( $block_content['bc_btn_text_color_mobile'] ) : $ays_sccp_bc_btn_text_color;
...
// Block content button border radius Mobile
$ays_sccp_bc_btn_radius = (isset($block_content['bc_btn_radius']) && $block_content['bc_btn_radius'] != '') ? $block_content['bc_btn_radius'] : '3';

// Enable Block content button border radius Mobile
$block_content['enable_bc_btn_radius_mobile'] = isset( $block_content['enable_bc_btn_radius_mobile'] ) && $block_content['enable_bc_btn_radius_mobile'] == 'off' ? 'off' : 'on';
$enable_ays_sccp_bc_btn_radius_mobile = $block_content['enable_bc_btn_radius_mobile'] == 'on' ?  true : false;

// Block content button border radius Mobile
$ays_sccp_bc_btn_radius_mobile = isset( $block_content['bc_btn_radius_mobile'] ) && $block_content['bc_btn_radius_mobile'] != '' ? esc_attr( $block_content['bc_btn_radius_mobile'] ) : $ays_sccp_bc_btn_radius;
...
// Enable Block content button border width Mobile
$block_content['enable_bc_btn_border_width_mobile'] = isset( $block_content['enable_bc_btn_border_width_mobile'] ) && $block_content['enable_bc_btn_border_width_mobile'] == 'off' ? 'off' : 'on';
$enable_ays_sccp_bc_btn_border_width_mobile = $block_content['enable_bc_btn_border_width_mobile'] == 'on' ?  true : false;

// Block content button border width Mobile
$ays_sccp_bc_btn_border_width_mobile = isset( $block_content['bc_btn_border_width_mobile'] ) && $block_content['bc_btn_border_width_mobile'] != '' ? esc_attr( $block_content['bc_btn_border_width_mobile'] ) : $ays_sccp_bc_btn_border_width;
...
// Enable Block content Buttons border style Mobile
$block_content['enable_bc_btn_border_style_mobile'] = isset( $block_content['enable_bc_btn_border_style_mobile'] ) && $block_content['enable_bc_btn_border_style_mobile'] == 'off' ? 'off' : 'on';
$enable_ays_sccp_bc_btn_border_style_mobile = $block_content['enable_bc_btn_border_style_mobile'] == 'on' ?  true : false;

// Block content Buttons border style Mobile
$ays_sccp_bc_btn_border_style_mobile = isset( $block_content['bc_btn_border_style_mobile'] ) && $block_content['bc_btn_border_style_mobile'] != '' ? esc_attr( $block_content['bc_btn_border_style_mobile'] ) : $ays_sccp_bc_btn_border_style;
...
$block_content['enable_bc_btn_border_color_mobile'] = isset( $block_content['enable_bc_btn_border_color_mobile'] ) && $block_content['enable_bc_btn_border_color_mobile'] == 'off' ? 'off' : 'on';
$enable_ays_sccp_bc_btn_border_color_mobile = $block_content['enable_bc_btn_border_color_mobile'] == 'on' ?  true : false;

// Block content box Buttons border color Mobile
$ays_sccp_bc_btn_border_color_mobile = isset( $block_content['bc_btn_border_color_mobile'] ) && $block_content['bc_btn_border_color_mobile'] != '' ? esc_attr( $block_content['bc_btn_border_color_mobile'] ) : $ays_sccp_bc_btn_border_color;
...
$block_content['enable_bc_btn_padding_mobile'] = isset( $block_content['enable_bc_btn_padding_mobile'] ) && $block_content['enable_bc_btn_padding_mobile'] == 'off' ? 'off' : 'on';
$enable_ays_bc_btn_padding_mobile = $block_content['enable_bc_btn_padding_mobile'] == 'on' ?  true : false;

// Block content Buttons padding Mobile
$ays_bc_buttons_left_right_padding_mobile = isset( $block_content['bc_btn_left_right_padding_mobile'] ) && $block_content['bc_btn_left_right_padding_mobile'] != '' ? esc_attr( $block_content['bc_btn_left_right_padding_mobile'] ) : $ays_bc_buttons_left_right_padding;

$ays_bc_buttons_top_bottom_padding_mobile = (isset($block_content['bc_btn_top_bottom_padding_mobile']) && $block_content['bc_btn_top_bottom_padding_mobile'] != '') ? esc_attr( $block_content['bc_btn_top_bottom_padding_mobile'] ) : $ays_bc_buttons_top_bottom_padding;
...
// Subscribe Button text color color
...
// Enable Subscribe Button text color color Mobile
$subscribe['enable_sub_btn_text_color_mobile'] = isset( $subscribe['enable_sub_btn_text_color_mobile'] ) && $subscribe['enable_sub_btn_text_color_mobile'] == 'off' ? 'off' : 'on';
$enable_ays_sccp_sub_btn_text_color_mobile = $subscribe['enable_sub_btn_text_color_mobile'] == 'on' ?  true : false;

// Subscribe Button text color color Mobile
$ays_sccp_sub_btn_text_color_mobile = isset( $subscribe['sub_btn_text_color_mobile'] ) && $subscribe['sub_btn_text_color_mobile'] != '' ? esc_attr( $subscribe['sub_btn_text_color_mobile'] ) : $ays_sccp_sub_btn_text_color;
...
// Subscribe button border radius
$ays_sccp_sub_btn_radius = (isset($subscribe['sub_btn_radius']) && $subscribe['sub_btn_radius'] != '') ? $subscribe['sub_btn_radius'] : '3';

// Enable Subscribe button border radius Mobile
$subscribe['enable_sub_btn_radius_mobile'] = isset( $subscribe['enable_sub_btn_radius_mobile'] ) && $subscribe['enable_sub_btn_radius_mobile'] == 'off' ? 'off' : 'on';
$enable_ays_sccp_sub_btn_radius_mobile = $subscribe['enable_sub_btn_radius_mobile'] == 'on' ?  true : false;

// Subscribe button border radius Mobile
$ays_sccp_sub_btn_radius_mobile = isset( $subscribe['sub_btn_radius_mobile'] ) && $subscribe['sub_btn_radius_mobile'] != '' ? esc_attr( $subscribe['sub_btn_radius_mobile'] ) : $ays_sccp_sub_btn_radius;
...
$subscribe['enable_sub_btn_border_color_mobile'] = isset( $subscribe['enable_sub_btn_border_color_mobile'] ) && $subscribe['enable_sub_btn_border_color_mobile'] == 'off' ? 'off' : 'on';
$enable_ays_sccp_sub_btn_border_color_mobile = $subscribe['enable_sub_btn_border_color_mobile'] == 'on' ?  true : false;

// Subscribe box Buttons border color Mobile
$ays_sccp_sub_btn_border_color_mobile = isset( $subscribe['sub_btn_border_color_mobile'] ) && $subscribe['sub_btn_border_color_mobile'] != '' ? esc_attr( $subscribe['sub_btn_border_color_mobile'] ) : $ays_sccp_sub_btn_border_color;
                     ...
                     <div id="tab3" class="ays-sccp-tab-content <?php echo ($ays_sccp_tab == 'tab3') ? 'ays-sccp-tab-content-active' : ''; ?>">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                ...
                                <p class="vmessage">
                                    <strong>
                                        <input type="text" onClick="this.setSelectionRange(0, this.value.length)" readonly value="%%post_author_website_url%%" />
                                    </strong>
                                    <span> - </span>
                                    <span style="font-size:18px;">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 ays_divider_left">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 ays_divider_left ays_sccp_display_flex">
                                        <div>
                                        	<input type="number" class="ays-text-input ays-text-input-short" id='ays_sccp_bc_width_mobile' name='ays_sccp_bc_width_mobile' value="<?php echo $ays_sccp_bc_width_mobile; ?>"/>
                                        </div>
                                        <div class="ays_sccp_dropdown_max_width">
                            ...
                            <div class="sccp_position_block col-sm-8 ays_divider_left ays_toggle_mobile_parent">
                            	<div class="ays_sccp_img_position_tables_container" style="display: flex;">
	                                ...
	                                <div class="ays_toggle_target ays_divider_left ays_sccp_bc_bg_image_position_mobile_container" style=" <?php echo ( $enable_sccp_bc_bg_image_position_mobile ) ? '' : 'display:none'; ?>">
	                                    ...
	                                    <input type="hidden" name="ays_bc_bg_image_position_mobile" id="ays-sccp-bc-position-mobile-val" value="<?php echo $sccp_bc_bg_image_position_mobile; ?>" class="ays-sccp-position-mobile-val-class">
	                                </div>
                                </div>
                                <div class="ays_sccp_mobile_settings_container">
