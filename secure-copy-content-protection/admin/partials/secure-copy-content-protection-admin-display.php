...
$sccp_message_vars = array(  
    ...
    '%%user_website_url%%'              => esc_html__("User's Website URL", 'secure-copy-content-protection'),
    '%%user_wordpress_roles%%'          => esc_html__("User's Wordpress Roles", 'secure-copy-content-protection'),
    '%%user_ip_address%%'               => esc_html__("User's IP Address", 'secure-copy-content-protection'),
    ...
    '%%home_page_url%%'                 => esc_html__("Home Page URL", 'secure-copy-content-protection'),
);
