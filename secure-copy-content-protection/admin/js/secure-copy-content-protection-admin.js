(function ($) {
    ...
    $(document).ready(function () {
        ...
        $('#sub_reset_to_default').on('click', function () {
            ...
            $(document).find('#sub_bg_color_mobile').val('#fff').change();
            $(document).find("#enable_sub_bg_color_mobile").prop('checked', true).change();
            ...
            $(document).find('#ays_sub_title_transformation_mobile').val('none').change();
            $(document).find("#enable_ays_sub_title_transformation_mobile").prop('checked', true).change();
            
            $(document).find('#ays_sccp_sub_cont_border_style').val('solid').change();
            $(document).find('#ays_sccp_sub_cont_border_style_mobile').val('solid').change();
            ...
            $(document).find('#ays_sccp_sub_button_text_mobile').val('Subscribe').change();
            $(document).find("#enable_ays_sccp_sub_button_text_mobile").prop('checked', true).change();
            ...
            $(document).find('#ays_sccp_sub_btn_text_color_mobile').val('#000').change();
            $(document).find("#enable_ays_sccp_sub_btn_text_color_mobile").prop('checked', true).change();
            ...
            $(document).find('#ays_sccp_sub_btn_radius_mobile').val('3').change();
            $(document).find("#enable_ays_sccp_sub_btn_radius_mobile").prop('checked', true).change();

            $(document).find('#ays_sccp_sub_btn_border_width').val('1').change();
            $(document).find('#ays_sccp_sub_btn_border_width_mobile').val('1').change();
            ...
            $(document).find('#ays_sccp_sub_btn_border_color_mobile').val('#000').change();
        ...
        $('#bc_reset_to_default').on('click', function () {
            ...
            $(document).find('#bc_text_color_mobile').val('#000').change();
            ...
            $(document).find('#ays_sccp_bc_cont_border_style_mobile').val('double').change();
            $(document).find("#enable_ays_sccp_bc_cont_border_style_mobile").prop('checked', true).change();
            
            $(document).find('#ays_sccp_bc_cont_border_color').val('#c5c5c5').change();
            $(document).find('#ays_sccp_bc_cont_border_color_mobile').val('#c5c5c5').change();            
            $(document).find("#enable_ays_sccp_bc_cont_border_color_mobile").prop('checked', true).change(); 

            $(document).find('#ays_sccp_bc_cont_border_width').val('4').change();
            $(document).find('#ays_sccp_bc_cont_border_width_mobile').val('4').change();            
            ...
            $(document).find('#ays_sccp_bc_input_font_size').val('').change();
            $(document).find('#ays_sccp_bc_input_font_size_mobile').val('').change();            
            $(document).find("#enable_ays_sccp_bc_input_font_size_mobile").prop('checked', true).change(); 
            ...
            $(document).find('#ays_sccp_bc_btn_text_color_mobile').val('#000').change();            
            $(document).find("#enable_ays_sccp_bc_btn_text_color_mobile").prop('checked', true).change(); 
            ...
            $(document).find('#ays_sccp_bc_btn_radius_mobile').val('3').change();
            $(document).find("#enable_ays_sccp_bc_btn_radius_mobile").prop('checked', true).change(); 
            
            $(document).find('#ays_sccp_bc_btn_border_width').val('1').change();
            $(document).find('#ays_sccp_bc_btn_border_width_mobile').val('1').change();
            ...
            $(document).find('#ays_sccp_bc_btn_border_color_mobile').val('#c5c5c5').change();
            $(document).find("#enable_ays_sccp_bc_btn_border_color_mobile").prop('checked', true).change();
        ...
        $('#ays_sccp_sub_btn_text_color_mobile').wpColorPicker({
            defaultColor: '#000000',
            change: function(event, ui) {
                $('#ays_tooltip, #ays_tooltip>*').css('color', ui.color.toString())
            }
        ...
        $('#ays_sccp_bc_btn_text_color_mobile').wpColorPicker({
            defaultColor: '#000000',
            change: function(event, ui) {
                $('#ays_tooltip, #ays_tooltip>*').css('color', ui.color.toString())
            }
        ...
        $('#ays_sccp_sub_btn_border_color_mobile').wpColorPicker({
            defaultColor: '#000000',            
        });
        $('#ays_sccp_bc_btn_border_color').wpColorPicker({
            defaultColor: '#c5c5c5',
        });
        $('#ays_sccp_bc_btn_border_color_mobile').wpColorPicker({
            defaultColor: '#c5c5c5',
        });
        ...
        $('#ays_sccp_bc_cont_border_color_mobile').wpColorPicker({
            defaultColor: '#c5c5c5',            
        });
        ...
        $('#bc_text_color_mobile').wpColorPicker({
            defaultColor: '#000',
        });
        $('#sub_bg_color').wpColorPicker({
            defaultColor: '#fff',
        });
        $('#sub_bg_color_mobile').wpColorPicker({
            defaultColor: '#fff',
        });
