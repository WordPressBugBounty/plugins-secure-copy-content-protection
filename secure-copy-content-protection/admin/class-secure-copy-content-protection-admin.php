	...
	public function add_action_links( $links ) {
		...
		*/
		$settings_link = array(
            ...
            '<a href="https://ays-pro.com/wordpress/secure-copy-content-protection?utm_source=dashboard-sccp&utm_medium=free-sccp&utm_campaign=buy-now-sccp" class="ays-sccp-upgrade-plugin-btn" target="_blank" style="color:#01A32A; font-weight:bold;">' . __('Upgrade 30% + 20% Sale', $this->plugin_name) . '</a>',
		);
